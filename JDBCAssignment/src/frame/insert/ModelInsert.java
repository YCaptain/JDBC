...
public class ModelInsert {
	...
	public void run() {
		try {
			ModelInsert window = new ModelInsert();
		...
		if(contentPane == null) {
			...
			btnSearch.addMouseListener(new MouseAdapter() {
				...
				public void mouseClicked(MouseEvent event) {
					...
					int modelNum = Integer.parseInt(txt);
					model = new Model();
					model.updateModelNum(modelNum);
					model.updateModelName(modelName.getText());
					model.updateManufacturer(manufacturer.getText());
